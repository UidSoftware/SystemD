...
def montar_briefing(manutencao):
    ...
    return (
        ...
        "INSTRUCAO FINAL — SOMENTE O PILOT executa isto. NUNCA o Sentinel, "
        "o Planner ou qualquer outro agente — mesmo que a validacao ja "
        "tenha aprovado:\n"
        "1. Sentinel valida de verdade (sobe containers, roda migrate, "
        "testa endpoints reais) e PARA — so reporta aprovado/reprovado, "
        "nunca faz deploy nem roda o comando abaixo.\n"
        "2. So depois do Sentinel aprovar, o Pilot (chamado separadamente) "
        "faz o deploy real em producao e, so ele, ja com o deploy "
        "confirmado, roda:\n"
