...
@admin.register(UsuarioEmailConfig)
class UsuarioEmailConfigAdmin(admin.ModelAdmin):
    list_display = ('usuario', 'email_conta', 'ativo', 'criado_em')
    list_filter = ('ativo',)
    search_fields = ('usuario__email', 'email_conta')
